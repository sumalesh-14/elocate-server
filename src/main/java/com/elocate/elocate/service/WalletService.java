...
public class WalletService {
    ...
    public void creditWallet(UUID userId, RecycleRequest recycleRequestId, BigDecimal points, String description) {
        ...
        BigDecimal conversionRate = wallet.getPointsToMoneyRate() != null ? 
                wallet.getPointsToMoneyRate() : defaultPointsToMoneyRate;
    ...
    public void adjustWalletForPriceChange(UUID userId, RecycleRequest recycleRequest, 
        ...
        log.info("Wallet balance adjusted: {} → {}", wallet.getPointsBalance().subtract(pointsDifference), newBalance);
    ...
    public WalletBalanceResponse getWalletBalanceWithConversion(UUID userId) {
        ...
        return WalletBalanceResponse.builder()
                ...
                .monetaryAmount(monetaryAmount)
                .currencyCode(wallet.getCurrencyCode() != null ? wallet.getCurrencyCode() : defaultCurrencyCode)
                .conversionRate(conversionRate)
                .build();
    }
