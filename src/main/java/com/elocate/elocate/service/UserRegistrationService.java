...
public class UserRegistrationService {
    ...
    public String register(UserRegistrationDto dto) {
        ...
        if (userRepository.existsByEmail(dto.getEmail())) {
            throw new com.elocate.elocate.exception.AccountAlreadyExistsException(
        ...
        if (userRepository.existsByMobileNumber(dto.getMobileNumber())) {
            throw new com.elocate.elocate.exception.DuplicateMobileNumberException(
        ...
        try {
            ...
            if (e.getMessage().contains("User already exists") || e.getMessage().contains("email_exists")
                ...
                throw new com.elocate.elocate.exception.AccountAlreadyExistsException(
                        "Email already registered in Auth0");
            }
